...
postcardsCollection.insert(
{
	...
	imgURL: "assets/images/popDestinations/1.jpg",
...
postcardsCollection.insert(
{
	...
	imgURL: "assets/images/popDestinations/2.jpg",
...
postcardsCollection.insert(
{
	...
	imgURL: "assets/images/popDestinations/3.jpg",
...
postcardsCollection.insert(
{
	...
	userID: 456,
	title: "Space Needle",
	imgURL: "assets/images/popDestinations/4.jpg",
...
postcardsCollection.insert(
{
	...
	userID: 456,
	title: "Ballard Locks",
	imgURL: "assets/images/popDestinations/5.jpg",
...
postcardsCollection.insert(
{
	...
	userID: 456,
	title: "Alki Beach",
	imgURL: "assets/images/popDestinations/6.jpg",
...
postcardsCollection.insert(
{
	...
	imgURL: "assets/images/popDestinations/7.jpg",
...
postcardsCollection.insert(
{
	...
	userID: 346,
	title: "Pikes Place",
	imgURL: "assets/images/popDestinations/8.jpg",
...
postcardsCollection.insert(
{
	...
	imgURL: "assets/images/popDestinations/9.jpg",
...
postcardsCollection.insert(
{
	...
	userID: 456,
	title: "AmazonGo",
	imgURL: "assets/images/popDestinations/10.jpg",
